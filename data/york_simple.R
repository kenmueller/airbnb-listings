...
genMCMC = function(datFrm ,
  ...
  runJagsOut <- run.jags(
    ...
    # model = "model_simple.jags" ,
    model = "model_simple_t.jags" ,
    # model = "model_simple_t_uniform.jags" ,
    monitor = parameters ,
    data = dataList ,
    inits = initsList ,
    n.chains = nChains ,
...
xMetName = "bedrooms"             # the covariate
...
fileNameRoot = "kenparables_simple-t-"
graphFileType = "png"
...
# plot Bergen Beach (Brooklyn), Fresh Meadows (Queens), and SoHo (Manhattan) neighborhoods
plotMCMC2(
  mcmcCoda ,
  data = myDataFrame ,
  yName = yName ,
